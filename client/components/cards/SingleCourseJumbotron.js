...
const SingleCourseJumbotron=({course,showModal,
    setShowModal,preview,
    setPreview,loading,user
...
{
    const {name,description,instructor,
        updatedAt,
        lessons,
        image,
        price,
            ...
            <div className="row">
                ...
                <div className="col-md-4 mt-3">
                    ...
                    <div onClick={()=>
                    {
                        ...
                        playing={true} width="100%" height="225px"
                        />
                    </div>
                    ):
                    (
